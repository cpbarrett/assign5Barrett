    ...
    public static void main(String[] args) {
      ...
      //villian catchphrase
        ...
        while(hero1.getHp() > 0 && villain1.getHp() > 0) {
            ...
            System.out.println(villain1.getName() + " attacks and deals " + damage + " points of damage.");
            
            damage = hero1.attack();
            villain1.setHp(villain1.getHp() - damage);
            System.out.println(hero1.getName() + " attacks and deals " + damage + " points of damage.");
